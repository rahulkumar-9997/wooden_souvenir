...
$(document).ready(function () {
    ...
    $(document).on('click', 'a[data-add-banner-popup="true" ]', function () {
    ...
    $(document).off('submit', '#addNewBanner').on('submit', '#addNewBanner', function (event) {
    ...
    $(document).on('click', 'a[ data-edit-banner-popup="true"]', function () {
        var title = $(this).data('title');
        var size = ($(this).data('size') == '') ? 'md' : $(this).data('size');
        var url = $(this).data('url');
    ...
    $(document).off('submit', '#editBanner').on('submit', '#editBanner', function (event) {
        event.preventDefault();
        var form = $(this);
        var submitButton = form.find('button[type="submit"]');
        $('.form-control').removeClass('is-invalid');
